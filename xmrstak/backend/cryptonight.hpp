...
enum xmrstak_algo
{
	...
	cryptonight_saronite = 12 // derived from cryptonight_heavy with minor tweaks
};
...
template<>
inline constexpr size_t cn_select_memory<cryptonight_saronite>() { return CRYPTONIGHT_HEAVY_MEMORY; }
...
template<>
inline constexpr uint32_t cn_select_mask<cryptonight_saronite>() { return CRYPTONIGHT_HEAVY_MASK; }
...
template<>
inline constexpr uint32_t cn_select_iter<cryptonight_saronite>() { return CRYPTONIGHT_HEAVY_ITER; }
