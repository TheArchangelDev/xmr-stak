...
// cryptonight_heavy || cryptonight_haven || cryptonight_bittube2 || cryptonight_saronite
...
// cryptonight_heavy or cryptonight_haven || cryptonight_bittube2 || cryptonight_saronite
#if (ALGO == 4 || ALGO == 9 || ALGO == 10 || ALGO == 12)
	/* Also left over threads perform this loop.
	 * The left over thread results will be ignored
	 */
